...
function buildRAGReference(chunks, patterns) {
  ...
  ragSection += '이 청크들의 **감정 흐름과 톤만 참고**하여 새로운 대본을 작성하세요.\n';
  ragSection += '단, 원문을 그대로 쓰지 말고 **감정 패턴만 활용해 완전히 새로운 대본**을 만드세요.\n';
  ragSection += '⚠️ **중요**: 참고 청크의 형식을 따라하지 말고, 반드시 요청된 표준 대본 형식을 사용하세요.\n';
