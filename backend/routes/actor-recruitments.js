...
if (!fs.existsSync(uploadsDir)) {
  ...
  console.log('📁 [actor-recruitments] uploads/recruitments 디렉토리 생성됨:', uploadsDir);
}
...
const storage = multer.diskStorage({
  ...
  filename: function (req, file, cb) {
    ...
    // 파일 정보 상세 로깅
    console.log('📷 [actor-recruitments] multer 파일 정보:', {
    ...
    if (!ext) {
      console.log('⚠️ [actor-recruitments] 확장자 없음, mimetype으로 추정:', file.mimetype);
      ...
      console.log('✅ [actor-recruitments] 추정된 확장자:', ext);
    }
    
    const filename = 'recruitment-' + uniqueSuffix + ext;
    console.log('📁 [actor-recruitments] 최종 파일명:', filename);
