...
const { generateChildrenTheaterScript } = require('../helpers/childrenTheaterTemplate');
...
router.post('/generate', authenticateToken, async (req, res) => {
  ...
  const genreDirectives = {
      ...
      `,
        '동물 친구들': `
      어린이들이 좋아하는 동물 캐릭터들이 등장하는 교육적이고 재미있는 연극 대본을 써줘.
      동물들의 특성을 살린 귀여운 말투와 행동으로 우정, 협력, 나눔의 가치를 전달해.
      갈등이 있더라도 폭력적이지 않고 대화로 해결하는 과정을 보여주고,
      모든 등장인물이 행복한 결말을 맞도록 해. 교훈적이지만 재미있게!
      `,
        '마법의 세계': `
      상상력 넘치는 마법의 세계에서 펼쳐지는 어린이 판타지 연극 대본을 써줘.
      마법사, 요정, 용 등 판타지 캐릭터들이 등장하며 선악이 명확하게 구분되고,
      용기, 정의, 친절함의 가치를 보여주는 모험 이야기로 구성해.
      무서운 요소는 최소화하고 신비롭고 아름다운 분위기로 작성해.
      `,
        '우정과 모험': `
      어린이들의 우정과 모험을 테마로 한 따뜻하고 신나는 연극 대본을 써줘.
      친구들이 함께 문제를 해결하고 서로 도우며 성장하는 과정을 그려내고,
      소통, 배려, 협력의 중요성을 자연스럽게 보여줘.
      위험한 상황이 있어도 현실적이고 안전한 수준으로 설정해.
      `,
        '학교 생활': `
      어린이들의 일상적인 학교 생활을 소재로 한 공감 가능한 연극 대본을 써줘.
      학습, 놀이, 친구 관계, 선생님과의 관계 등을 다루며
      학교에서 일어날 수 있는 작은 갈등들을 긍정적으로 해결하는 과정을 보여줘.
      교육적 가치와 재미를 동시에 담아 현실적이면서도 희망적으로 작성해.
      `,
        '가족 이야기': `
      가족의 사랑과 소중함을 테마로 한 따뜻한 가족 연극 대본을 써줘.
      부모와 자녀, 형제자매, 조부모 등 다양한 가족 관계를 다루며
      가족 간의 이해, 사랑, 화해의 과정을 감동적으로 그려내.
      세대 간의 차이를 인정하면서도 가족의 유대감을 강조하는 내용으로 구성해.
      `,
        '꿈과 상상': `
      어린이들의 무한한 상상력과 꿈을 주제로 한 창의적인 연극 대본을 써줘.
      현실과 상상의 경계를 넘나드는 환상적인 이야기로 구성하고,
      꿈을 포기하지 않는 용기와 상상력의 힘을 보여줘.
      기발하고 창의적인 상황들을 만들어 어린이들의 호기심을 자극해.
      `
