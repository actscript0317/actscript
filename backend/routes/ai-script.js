 ...
 **4.1 길이와 형태**
 보통 3~6자 정도의 짧은 동사·형용사 중심, 행동 + 감정 or 감정 단독
 예시: (고개를 돌린다), (울먹이며), (차갑게), (놀란 듯)

 **4.2 사용 빈도**
 한 장면에 너무 많지 않게 → 평균 3~5줄 대사에 한 번 정도, 감정 변화가 크지 않으면 생략
...
**6. 형식:**  
제목: 감정이나 상황을 압축한 제목 
상황 설명: 어떤 상황에서 누구에게 하는 말인지, 왜 이런 감정 상태인지, 상황과 맥락을을 3-4줄로 설명  
인물: 성+이름, 나이, 성격과 현재 상황 간략 설명 
