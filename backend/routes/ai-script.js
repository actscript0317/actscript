...
**5. 대본 대사 줄바꿈 규칙**
 - 화자가 바뀌면 무조건 한 줄 이상 띄움(공백 사용).
 - 같은 화자라도 감정, 주제, 분위기가 전환되면 줄바꿈.
 - 한 화자의 대사는 2~3문장마다 줄을 바꿔 호흡을 살린다.
 - 장면 전환, 시간 경과, 감정의 급격한 단절이 있을 때만 한 줄 이상 띄움(공백 사용).
 - 지시문은 대사 전후에 줄을 바꾸고, 독립된 줄로 작성.
 - 불필요한 과도한 줄바꿈과 공백은 금지.
 - 전체적으로 실제 한국 드라마 대본의 흐름처럼 자연스럽게 유지.
