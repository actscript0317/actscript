...
router.post('/generate', authenticateToken, async (req, res) => {
  try {
    ...
    const characterDirectivesMap = {
      '1': {
        대사구조: '자기 고백형 서사로 독백하듯이 내면의 솔직한 이야기를 말하는 구조',
        서사구조: '1. 시작(도입) — 현재 상황과 말하게 된 이유를 짧고 명확하게 제시. 2. 전개(상세 묘사) — 구체적인 사건, 기억, 감정의 원인을 풀어냄. 3. 상승(감정 고조) — 감정이 점점 커지고 목소리·어휘가 변하는 부분. 4. 절정(폭발 또는 전환) — 감정의 최고조, 결심, 깨달음이 드러나는 순간. 5. 결말(여운) — 짧고 강한 문장, 혹은 체념과 여운이 남는 한 줄로 마무리. 6. 전개는 반드시 ‘감정 축적 → 최고조 → 마무리’의 흐름을 따른다.',
      },
