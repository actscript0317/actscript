...
- 캐릭터가 현실에서 실제로 쓸 법한 자연스러운 말투만 사용하기.
- 마지막 대사는 한 박자 쉬는 단문으로, 감정이 남도록 구성.
- 대본과 상황을 정확하게 일치할 것. 예: 누군가에게 고백하는 장면이라면 그 대상 앞에서 말하는 대사, 지시문, 상황을 일치시킬 것.

**4.지시문 작성 규칙**
- 지시문은 감정, 행동, 상황·톤 순으로 우선순위를 둔다.  
- 한 장면 5~6줄 대사에 1~2개 정도, 감정 변화 큰 부분에만 삽입.  
- 지시문 위치를 대사 앞, 중간, 뒤로 명확히 구분해 작성.  
- 3~6자 내외의 간결하고 구체적인 표현 사용.  
- 배우 해석을 존중하여 과도한 지시문은 피한다.  
- 현실적이고 자연스러운 연기 지시를 목표로 한다.
 ...
 **이지원:**  
 ...
 (잠시 창밖을 바라보다가 한숨을 쉰다. 두 손을 주머니에 넣고 어깨를 으쓱인다.)

**이지원:** 
 내가 뭘 잘못했을까? 밤새워 공부하고, 최선을 다했는데... 왜 아무것도 안 풀릴까?  

 (눈을 감고 고개를 젓는다. 감정이 점점 고조된다.)

**이지원:** 
 부모님 기대에 부응하고 싶어. 친구들이 하나둘 취직하는 소식 들으면, 마음이 무너져. 난 언제쯤...  
