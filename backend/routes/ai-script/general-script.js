...
**🔥 핵심 내용 규칙 - 설득력 있는 독백을 위한 필수사항**

**❌ 절대 금지 - 단순 감정 나열:**
- "나는 너를 좋아해", "많이 슬퍼", "화가 나" 같은 감정만 말하기
- 추상적이고 뜬구름 잡는 표현

**✅ 반드시 포함 - 구체적 맥락과 사건 (매번 새롭고 창의적으로):**
1. **구체적 시공간**: 언제, 어디서 만났는지 독창적인 상황 설정
2. **세부 행동과 상황**: 그때 실제로 한 행동들, 습관, 몸짓을 생생하게 묘사
3. **감정 변화의 구체적 계기**: 마음이 바뀐 특정 순간이나 사건을 상세히
4. **생생한 기억들**: 시각적, 청각적 디테일을 포함한 기억 장면들

**독백 작성 패턴 (참고용 - 내용은 매번 완전히 새롭게 창작):**
- 시작: 구체적인 첫 만남이나 중요한 순간으로 시작
- 전개: 그 이후 벌어진 구체적 행동들과 변화 과정
- 클라이막스: 결정적 순간이나 깨달음의 계기
- 마무리: 현재 심정이나 결심을 담은 여운 있는 마무리

**💡 창의적 맥락 아이디어 (매번 다르게 활용):**
- 만남의 장소: 카페, 지하철, 회사, 학교, 공원, 병원, 서점, 공연장, 헬스장 등
- 관계의 시작: 우연한 만남, 소개팅, 동료, 이웃, 온라인, 취미모임 등  
- 감정 변화 계기: 특별한 대화, 몸짓, 표정, 상황, 도움, 오해, 이별 위기 등
- 시간적 배경: 계절, 시간대, 특별한 날, 기념일, 시험기간, 휴가 등
...
**⚠️ 절대 규칙:** 
- 모든 대사는 "캐릭터명: 대사내용" 형식 (번호 없음)
- 서술형 지시문은 [캐릭터는 감정적 행동을 한다] 형식 활용
- 자연스러운 서술 문체 적극 사용
...
2. **독백 내용의 핵심 - 구체적 맥락 필수**:
   - 단순 감정 표현 금지: "나는 슬프다", "너를 좋아한다" 등
   - 반드시 포함해야 할 것들:
     * 구체적인 과거 사건 ("2년 전 시험기간에 처음 만났을 때...")
     * 세부적인 행동과 상황 ("네 노트 필기를 엿보는 척을 했어...")
     * 감정 변화의 이유 ("네가 다른 사람 얘기할 때마다 심장이...")

3. **대사 형식 절대 규칙**:
   - 모든 대사: "캐릭터명: 대사내용" (번호 없음)
   - 서술형 지시문: [캐릭터는 잠시 말을 찾는다] 형식 적극 활용
   - 감정과 행동을 자연스럽게 서술

4. **분량 준수**: 지정된 대사 줄 수에 최대한 맞춰 작성하세요.
5. **자연스러운 대사**: 각 인물의 특성에 맞는 자연스러운 대화를 작성하세요.

**🔥 가장 중요**: 
1. **창의적이고 구체적인 맥락 필수** - 매번 새로운 상황, 장소, 만남의 계기를 독창적으로 설정
2. **단순 감정 표현 절대 금지** - "좋아해", "슬퍼" 대신 구체적 행동과 사건으로 감정 표현
3. **다양성과 독창성** - 이전에 생성한 내용과 다른 새로운 맥락과 상황 창조
4. 섹션 헤더와 서술형 지시문 활용`
      },
      {
        role: "user",
