...
**형식 예시:**
✅ 올바른 형식 (반드시 이 형식만 사용):
1. 민수: (머뭇거리며) 안녕하세요, 처음 뵙겠습니다.
[민수가 밝게 웃으며 인사한다] ← 지시문 (번호 없음)
2. 영희: 반갑습니다! 

❌ 절대 사용 금지 형식:
- 민수: 안녕하세요 ← 번호 없음
- [민수는 잠시 말을 찾는다] ← 서술형 지시문
- 1. [민수가 웃는다] ← 지시문에 번호
- "민수가 웃으며 말한다" ← 따옴표 서술

**⚠️ 절대 규칙:** 
- 모든 대사는 "번호. 캐릭터명: (무대지시문) 대사" 형식만 사용
- [대괄호] 지시문은 번호 없이 별도 줄에 작성
- 서술형 문장 절대 금지
...
2. **대사 형식 절대 규칙**:
   - 모든 대사: "번호. 캐릭터명: (무대지시문) 대사"
   - 무대 지시문: [대괄호 안에 별도 줄로]
   - 서술형 문장 절대 금지

3. **분량 준수**: 지정된 대사 줄 수에 최대한 맞춰 작성하세요.
4. **자연스러운 대사**: 각 인물의 특성에 맞는 자연스러운 대화를 작성하세요.

**⚠️ 중요**: 섹션 헤더와 대사 형식을 정확히 지켜주세요. "[캐릭터는 말을 찾는다]" 같은 서술형 지시문은 절대 사용하지 마세요.`
      },
      {
        role: "user",
