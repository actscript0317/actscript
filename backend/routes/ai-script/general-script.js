...
**✅ 반드시 포함 - 구체적 맥락과 사건:**
1. **구체적 시공간**: "2년 전 시험기간 도서관에서", "작년 겨울 카페에서" 등
2. **세부 행동과 상황**: "네 노트 필기를 엿보는 척 했어", "매일 점심시간마다 너 찾았어" 등  
3. **감정 변화의 구체적 계기**: "네가 다른 사람 얘기할 때마다", "그날 네가 울고 있는 걸 봤을 때" 등
4. **생생한 기억들**: "네 웃는 모습", "그때 한 말", "그 순간의 느낌" 등

**독백 예시 (이런 구체적 맥락이 필요함):**
처음 네 옆자리에 앉았던 게 2년 전 시험기간이었지.
그때부터 난 괜히 물 마시러 가는 척, 네 노트 필기를 엿보는 척을 했어.
내 하루 절반은 네 주변을 맴도는 걸로 채워졌거든.
특히 네가 다른 사람 얘기할 때마다 심장이 쿵 내려앉았어.
...
**🔥 가장 중요**: 
1. 구체적 맥락 필수 - "2년 전 시험기간에", "네 노트 필기 엿보는 척" 같은 세부 사건과 행동 포함
2. 단순 감정 표현("좋아해", "슬퍼") 절대 금지
3. 섹션 헤더와 서술형 지시문("[캐릭터는 말을 찾는다]") 적극 활용`
      },
      {
        role: "user",
