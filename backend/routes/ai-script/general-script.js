...
**✅ [내용 규칙]
1. **상황**: 시간·장소·상황을 짧게 묘사하세요. (예: 도서관 시험기간, 비 오는 버스정류장)
2. **관계 맥락**: 상대와의 관계(친구, 연인, 가족, 동료 등)를 구체적으로 드러내세요.
3. **감정 이유**: 왜 이런 감정을 느끼는지 과거 사건이나 구체적인 계기를 반드시 포함하세요.
4. **감정 곡선**: 시작 → 갈등/망설임 → 고조 → 결심 → 마무리(여운) 순서로 흐름을 만드세요.
5. **마지막 한 줄**: 관객에게 여운을 주거나 반전이 되는 문장으로 마무리하세요.
