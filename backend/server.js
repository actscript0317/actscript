...
console.log('📂 [server.js] supabase-auth.js 임포트 중...');
const supabaseAuthRoutes = require('./routes/supabase-auth'); // Mailgun 인증 코드 방식
console.log('✅ [server.js] supabase-auth.js 임포트 완료');
...
console.log('📝 [server.js] /api/v2/auth 라우트 등록 중...');
app.use('/api/v2/auth', supabaseAuthRoutes); // Mailgun 인증 코드 방식
